...
void CameraPresets::RenderWindow() {
    ...
    if (CreatePreset) {
        ...
        ImGui::PopID();
        ImGui::Separator();
        ImGui::InputTextMultiline("Enter Code", &CodeAdder);
        ImGui::SameLine();
...
//    ImGui::Begin("Presets");
    ...
    //    if (!code.empty()) ImGui::TextUnformatted(code.c_str());

    //            if (ImGui::Button("Edit")){ 
    //                edit = !edit; 
    //                if(edit == true) EditPlayerName = playerName;
    //                tempCamera = {
    //                    playerName,
    //                    t_FOV,
    //                    t_Dis,
    ...
    //                    t_TrnSp
    //                };
    //                LOG("Edit Player Name {}", EditPlayerName);
    //            };
    //            ImGui::SameLine();
    //            if (ImGui::Button("Delete")) {
    //                DeletePlayerFromFile(playerName);
    //            }
    //            ImGui::SameLine();
    //            if (ImGui::Button("Copy Code")) {
    //                std::string combinedValues;
    //                combinedValues += playerName;
    //                for (std::string val : values) {
    //                    combinedValues += ' ' + val;
    //                }
    //                code = PresetEncode(combinedValues + "\n");
    //                LOG("Clicked Copy {}", playerName);
    //            }
    //            ImGui::SameLine(); 
    //            if (ImGui::TreeNode(playerName.c_str())) {
    //                ImGui::TextUnformatted("FOV: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[0].c_str());
    //                ImGui::TextUnformatted("Distance: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[5].c_str());
    //                ImGui::TextUnformatted("Height: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[1].c_str());
    //                ImGui::TextUnformatted("Angle: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[2].c_str());
    //                ImGui::TextUnformatted("Stiffness: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[3].c_str());
    //                ImGui::TextUnformatted("Swivel Speed: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[4].c_str());
    //                ImGui::TextUnformatted("Transition Speed: ");
    //                ImGui::SameLine();
    //                ImGui::TextUnformatted(values[6].c_str());

    //                ImGui::TreePop();
    //            }
    //            ImGui::PopID();
    //            
    //            if (edit && playerName == EditPlayerName) {
    //                ImGui::PushID(("editing" + playerName).c_str());
    //                LOG("Player name {} {}", playerName, EditPlayerName);
    //                

    //                ImGui::TextUnformatted(("Editing: " + playerName).c_str());
    //                ImGui::Begin(("Edit Preset " + playerName).c_str());
    ...
    //                    std::to_string(tempCamera.Stiffness),
    //                    std::to_string(tempCamera.SwivelSpeed),
    //                    std::to_string(tempCamera.Distance),
    //                    std::to_string(tempCamera.TransitionSpeed)
    //                };
    //                if (ImGui::Button("Save")) {
    //                    SaveDataToFile(playerName, t_Values);
    //                    edit = false;
    //                }
    //                ImGui::SameLine();

    //                if (ImGui::Button("Copy Current")) {
    //                    gameWrapper->Execute([this, &t_FOV, &t_Dis, &t_Ang, &t_Hei, &t_Sti, &t_SvlSp, &t_TrnSp](GameWrapper* gw) {
    //                        ProfileCameraSettings settings = gameWrapper->GetSettings().GetCameraSettings();

    //                        t_FOV = settings.FOV;
    //                        t_Dis = settings.Distance;
    //                        t_Ang = settings.Pitch;
    //                        t_Hei = settings.Height;
    //                        t_Sti = settings.Stiffness;
    //                        t_SvlSp = settings.SwivelSpeed;
    //                        t_TrnSp = settings.TransitionSpeed;
    //                    });
    //                }
    //                ImGui::End();
    //                ImGui::PopID();
    ...
    //        std::fstream outputFile(CameraFolder, std::ios::out);
